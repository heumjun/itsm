...
$(document).ready(function(){
	jqGridObj.jqGrid({ 
	    ...
	    colNames : ['SEQ', '아이디', '이름', '신청일자', '종류', '신청시작일', '신청종료일', '신청일수', '사유', 'STATUS_CODE', '상태', 'OPER'],
	    colModel : [
					...
					{name:'user_name',index:'user_name', width:40, align:'center', editable : false, hidden: false},
					{name:'req_date',index:'req_date', width:60, align:'center', editable : false, hidden: false},
					{name:'vac_type',index:'vac_type', width:50, align:'center', editable : false, hidden: true},
					{name:'vac_start_date',index:'vac_start_date', width:60, align:'center', editable : false, hidden: false},
					{name:'vac_end_date',index:'vac_end_date', width:60, align:'center', editable : false, hidden: false},
					{name:'vac_req_day',index:'vac_req_day', width:30, align:'center', editable : false, hidden: false},
					{name:'vac_req_reason',index:'vac_req_reason', width:150, align:'left', editable : false, hidden: false},
