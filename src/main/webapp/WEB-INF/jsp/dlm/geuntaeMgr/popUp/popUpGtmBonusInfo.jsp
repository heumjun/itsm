...
<div class="container-fluid">
	<!-- Breadcrumbs-->
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="#">사용자 대체휴가 현황</a></li>
	</ol>
...
$(document).ready(function(){
	jqGridObj.jqGrid({ 
	    datatype: 'json', 
	    mtype: 'POST',
	    url: 'dlm.geuntaeMgr.popUpGtmBonusInfoList.do',
	    postData : fn_getFormData('#application_form'),
	    colNames : ['SEQ', '아이디', '이름', '적용년도', '휴가일수', '발생사유', '등록일시', 'OPER'],
	    colModel : [
					...
					{name:'bonus_apply_year',index:'bonus_apply_year', width:40, align:'center', editable : false, hidden: false},
					{name:'bonus_day',index:'bonus_day', width:30, align:'center', editable : false, hidden: false},
					{name:'bonus_occur_reason',index:'bonus_occur_reason', width:120, align:'left', editable : false, hidden: false},
					{name:'create_date',index:'create_date', width:60, align:'center', editable : false, hidden: false},
